...
echo "  docker compose --profile agent --env-file ../secrets.env up -d --build vps-device"
echo "  docker compose --profile agent --env-file ../secrets.env logs vps-device -f --tail 30"
echo ""
