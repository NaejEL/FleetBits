...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | VIB-01 | Le cloisonnement par site des requêtes de télémétrie est appliqué par réécriture textuelle de l'expression, et reste contournable | sécurité | critical | 4 | L | moyen | oui | — | A_FAIRE |
| 2 | VIB-02 | Le chemin d'appel de provisionnement utilisé par l'appareil ne correspond à aucune route déclarée | maintenabilité | critical | 1 | XS | faible | oui | — | A_FAIRE |
| 3 | VIB-03 | Le contrat du fichier d'identité d'appareil diverge entre ses quatre producteurs et consommateurs | maintenabilité | critical | 3 | S | moyen | oui | VIB-02 | A_FAIRE |
...
| 5 | VIB-05 | Le fichier d'identité déposé sur l'appareil est évalué comme du code par l'interpréteur, avec les droits les plus élevés | sécurité | major | 3 | S | moyen | oui | VIB-03 | A_FAIRE |
...
- **Occurrences** : `FleetBits-api/app/routers/telemetry.py:256`, `:264`, `:280`, `:310`
...
- **Occurrences** : `FleetBits-agent/usr/lib/fleet-agent/firstboot.sh:66` (route réellement déclarée : `FleetBits-api/app/routers/devices.py:90`)
...
- **Occurrences** : `FleetBits-agent/usr/lib/fleet-agent/firstboot.sh:87`, `FleetBits-platform/ansible/roles/fleet_agent/templates/device-identity.conf.j2:17`, `FleetBits-api/app/routers/devices.py:144`
...
- **Occurrences** : `FleetBits-api/app/routers/devices.py:202` (comportement correct de référence : `devices.py:269`)
...
- **Occurrences** : `FleetBits-agent/usr/lib/fleet-agent/firstboot.sh:87`, `FleetBits-agent/usr/lib/fleet-agent/generate-config.sh:27`, `FleetBits-agent/usr/lib/fleet-agent/heartbeat.sh:27`
...
- **Occurrences** : `FleetBits-ui/static/js/sidebar-tree.js:196`, `:198`, `:201`, `:217`, `:219`, `:222`, `:236` ; fonction d'échappement défaillante en `:286`
...
- **Occurrences** : `FleetBits-platform/docker/mosquitto/docker-entrypoint.sh:51`, `:71`, `:72`
...
- **Occurrences** : `FleetBits-api/app/routers/packages.py:41`, `:83`, `:215`, `:534`, `:678`, `:1023`
...
- **Occurrences** : `FleetBits-api/app/routers/devices.py:120`, `:474`, `FleetBits-api/app/routers/deployments.py:158`, `FleetBits-api/app/routers/hotfixes.py:164`, `:194`
...
- **Occurrences** : `FleetBits-api/app/routers/auth.py:166` (état), `:181` (construction de la clé)
...
- **Occurrences** : `FleetBits-ui/blueprints/inventory.py:141`, `FleetBits-ui/templates/audit.html:76`, et 5 autres branches de classification devenues mortes
...
- **Occurrences** : `FleetBits-ui/api_client.py:308`, `:322`, `:332`, `:344`, `:537`, et 7 autres dans le même fichier
...
- **Occurrences** : `FleetBits-api/app/routers/deployments.py:133`, `FleetBits-api/app/models/audit.py:27`, `FleetBits-api/app/services/audit.py`
...
- **Occurrences** : `FleetBits-api/tests/test_security_package_flow.py`, `FleetBits-api/tests/test_security_telemetry.py`, `FleetBits-api/app/services/resolver.py`, `FleetBits-ui/blueprints/inventory.py`
...
- **Occurrences** : `FleetBits-api/app/routers/devices.py:144` (réglages : `FleetBits-api/app/config.py`)
